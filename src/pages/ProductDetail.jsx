      ...
      <div className="px-4 pt-5 space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-xs text-gray-400">community mentions</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-brand-50 rounded-2xl border border-brand-100 p-5">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h2 className="text-sm font-bold text-brand-600 uppercase tracking-wide">Community Verdict</h2>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-5 py-4 flex items-center gap-3">
          ...
          <div>
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide">Best For</p>
        ...
        {/* Source Breakdown */}
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          <h2 className="text-sm font-bold text-gray-800 mb-4">Mentions by Source</h2>
        ...
        <div className={`rounded-2xl border p-5 ${product.recall ? 'bg-red-50 border-red-200' : 'bg-white border-gray-100 shadow-sm'}`}>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-sm font-bold text-gray-800">Recall History</h2>
          </div>
          {product.recall && product.recallDetails ? (
            <div className="space-y-3">
              <div className="bg-red-100 rounded-xl p-3">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-xs font-bold text-red-700 bg-red-200 px-2 py-0.5 rounded-full">ACTIVE RECALL</span>
                  <span className="text-xs text-red-500">{product.recallDetails.date}</span>
                </div>
                <p className="text-xs text-red-700 font-medium mt-2">Reason</p>
                <p className="text-sm text-red-800 mt-1">{product.recallDetails.reason}</p>
                <p className="text-xs text-red-700 font-medium mt-3">Required Action</p>
                <p className="text-sm text-red-800 mt-1">{product.recallDetails.action}</p>
              </div>
              <p className="text-xs text-red-500">
                Source: CPSC recall database. Always verify with the manufacturer for the most current status.
              </p>
            </div>
          ) : (
            <p className="text-sm text-gray-500">No recalls on record for this product.</p>
          )}
        </div>
